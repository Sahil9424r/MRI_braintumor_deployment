...
def predict():
    ...
    image = load_img(BytesIO(file.read()), target_size=(256, 256))  # Use BytesIO to read the file
    ...
    labels = ['with_mask', 'without_mask']  # Use your model's labels
